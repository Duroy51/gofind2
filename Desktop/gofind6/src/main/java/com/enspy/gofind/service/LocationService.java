...
/**
 * Service Implementation for managing {@link com.enspy.gofind.domain.Location}.
 */
@Service
@Transactional
    ...
    public Optional<Location> partialUpdate(Location location) {
        ...
        return locationRepository
            ...
            .map(existingLocation -> {
                ...
                if (location.getPhotoPieces() != null) {
                    existingLocation.setPhotoPieces(location.getPhotoPieces());
                }
                if (location.getPhotoPiecesContentType() != null) {
                    existingLocation.setPhotoPiecesContentType(location.getPhotoPiecesContentType());
                }
