...
import com.enspy.gofind.service.TrajetService;
...
/**
 * REST controller for managing {@link com.enspy.gofind.domain.Trajet}.
 */
@RestController
...
public class TrajetResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Trajet>> getAllTrajets(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
