    ...
    <div>
      ...
      <div className="table-responsive">
        {locationList && locationList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('lieu')}>
                  Lieu <FontAwesomeIcon icon={getSortIconByFieldName('lieu')} />
                </th>
                ...
                <th className="hand" onClick={sort('photoPieces')}>
                  Photo Pieces <FontAwesomeIcon icon={getSortIconByFieldName('photoPieces')} />
                </th>
                <th>
            ...
            <tbody>
              {locationList.map((location, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {location.photoPieces ? (
                      <div>
                        {location.photoPiecesContentType ? (
                          <a onClick={openFile(location.photoPiecesContentType, location.photoPieces)}>
                            <img
                              src={`data:${location.photoPiecesContentType};base64,${location.photoPieces}`}
                        ...
                        <span>
                          {location.photoPiecesContentType}, {byteSize(location.photoPieces)}
                        </span>
                      </div>
                    ) : null}
                  </td>
          ...
          !loading && <div className="alert alert-warning">Aucun Location trouvé</div>
        )}
      </div>
      {totalItems ? (
