...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OBJETVOLEE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OBJETVOLEE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OBJETVOLEE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OBJETVOLEE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OBJETVOLEE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OBJETVOLEE actions', async () => {
      const arg = 42666;
