...
import static com.enspy.gofind.domain.TrajetAsserts.*;
...
class TrajetResourceIT {
    ...
    private static final String DEFAULT_HEUREARRIVEE = "AAAAAAAAAA";
    private static final String UPDATED_HEUREARRIVEE = "BBBBBBBBBB";
    ...
    private static final byte[] DEFAULT_IMAGE_VEHICULE = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_IMAGE_VEHICULE = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_IMAGE_VEHICULE_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_IMAGE_VEHICULE_CONTENT_TYPE = "image/png";
    ...
    public static Trajet createEntity(EntityManager em) {
        Trajet trajet = new Trajet()
            ...
            .imageVehicule(DEFAULT_IMAGE_VEHICULE)
            .imageVehiculeContentType(DEFAULT_IMAGE_VEHICULE_CONTENT_TYPE);
        return trajet;
    }
    ...
    public static Trajet createUpdatedEntity(EntityManager em) {
        Trajet trajet = new Trajet()
            ...
            .imageVehicule(UPDATED_IMAGE_VEHICULE)
            .imageVehiculeContentType(UPDATED_IMAGE_VEHICULE_CONTENT_TYPE);
        return trajet;
    }
    ...
    void getAllTrajets() throws Exception {
        ...
        restTrajetMockMvc
            ...
            .andExpect(jsonPath("$.[*].heurearrivee").value(hasItem(DEFAULT_HEUREARRIVEE)))
            ...
            .andExpect(jsonPath("$.[*].imageVehiculeContentType").value(hasItem(DEFAULT_IMAGE_VEHICULE_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].imageVehicule").value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_IMAGE_VEHICULE))));
    }
    ...
    void getTrajet() throws Exception {
        ...
        restTrajetMockMvc
            ...
            .andExpect(jsonPath("$.heuredepart").value(DEFAULT_HEUREDEPART))
            .andExpect(jsonPath("$.heurearrivee").value(DEFAULT_HEUREARRIVEE))
            ...
            .andExpect(jsonPath("$.imageVehiculeContentType").value(DEFAULT_IMAGE_VEHICULE_CONTENT_TYPE))
            .andExpect(jsonPath("$.imageVehicule").value(Base64.getEncoder().encodeToString(DEFAULT_IMAGE_VEHICULE)));
    }
