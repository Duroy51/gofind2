...
import org.enspy.gofind.service.LocationService;
...
/**
 * REST controller for managing {@link org.enspy.gofind.domain.Location}.
 */
@RestController
...
public class LocationResource {
    ...
    public ResponseEntity<List<Location>> getAllLocations(
        ...
        if ("annonce-is-null".equals(filter)) {
            log.debug("REST request to get all Locations where annonce is null");
            return new ResponseEntity<>(locationService.findAllWhereAnnonceIsNull(), HttpStatus.OK);
        }
