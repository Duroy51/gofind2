...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DECLARATIONVOL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DECLARATIONVOL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DECLARATIONVOL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DECLARATIONVOL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DECLARATIONVOL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DECLARATIONVOL actions', async () => {
      const arg = 42666;
