          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('marqueVehicule')}>
                  Marque Vehicule <FontAwesomeIcon icon={getSortIconByFieldName('marqueVehicule')} />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {trajetList.map((trajet, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{trajet.date ? <TextFormat type="date" value={trajet.date} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{trajet.heuredepart ? <TextFormat type="date" value={trajet.heuredepart} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{trajet.heurearrivee ? <TextFormat type="date" value={trajet.heurearrivee} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{trajet.lieudepart}</td>
                  <td>{trajet.lieuarrivee}</td>
                  <td>{trajet.nombreplace}</td>
                  <td>{trajet.prixplace}</td>
                  <td>{trajet.marqueVehicule}</td>
