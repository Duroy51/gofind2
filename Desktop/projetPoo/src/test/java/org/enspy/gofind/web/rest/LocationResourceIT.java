...
import static org.enspy.gofind.domain.LocationAsserts.*;
...
import org.enspy.gofind.domain.Location;
import org.enspy.gofind.repository.LocationRepository;
...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().datedebut(DEFAULT_DATEDEBUT).datefin(DEFAULT_DATEFIN).prix(DEFAULT_PRIX);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().datedebut(UPDATED_DATEDEBUT).datefin(UPDATED_DATEFIN).prix(UPDATED_PRIX);
        return location;
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.datedebut(UPDATED_DATEDEBUT).datefin(UPDATED_DATEFIN).prix(UPDATED_PRIX);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.datefin(UPDATED_DATEFIN).prix(UPDATED_PRIX);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.datedebut(UPDATED_DATEDEBUT).datefin(UPDATED_DATEFIN).prix(UPDATED_PRIX);
